 ...
 */
public class MyTitleBarLight extends RelativeLayout {
    ...
    public MyTitleBarLight(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public MyTitleBarLight(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    ...
    public MyTitleBarLight(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    private void init(){
        root = LayoutInflater.from(context).inflate(R.layout.view_title_bar_light, this, true);
