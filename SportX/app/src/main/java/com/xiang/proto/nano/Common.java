...
public interface Common {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 58: {
            ...
            if (i != 0) {
              System.arraycopy(this.imgs, 0, newArray, 0, i);
            }
  ...
  public static final class Equipment extends
    ...
    public Equipment clear() {
      name = "";
      count = 0;
      equipmentType = Common.PAO_BU_JI;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.equipmentType != Common.PAO_BU_JI) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            String[] newArray = new String[i + arrayLength];
            if (i != 0) {
              System.arraycopy(this.images, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = input.readString();
              input.readTag();
